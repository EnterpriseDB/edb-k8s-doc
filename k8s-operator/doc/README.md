## EDB Operator Documentation

Please read the [EDB Architecture and Requirements](architecture.md) to understand the primary concepts leveraged by the Operator and avoid possible mistakes.

* [EDB Architecture and Requirements](architecture.md)
