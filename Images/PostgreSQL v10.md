...
> The [Common Vulnerabilities and Exposures scan reports](https://quay.io/repository/edb/postgresql-10?tab=tags) contains a security report with all open CVEs.
...
To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://quay.io/repository/edb/postgresql-10) in the Quay container registry.
